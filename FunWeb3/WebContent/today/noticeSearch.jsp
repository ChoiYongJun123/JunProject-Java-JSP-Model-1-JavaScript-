...
// int count =  getBoardCount(search)
...
List<TodayBean> boardList=bdao.getBoardList(startRow,pageSize,search);
// 날짜 모양 변경   날짜 => 문자열
SimpleDateFormat sdf =new SimpleDateFormat("yyyy.MM.dd");
%>
<!-- 게시판 -->
<article>
<h1>Notice Search[전체 글 개수 : <%=count%>]</h1>
<table id="notice">
